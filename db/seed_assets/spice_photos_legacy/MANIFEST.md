# Spice product photo manifest (ARCHIVED 2026-09-16 — no longer used by `db/seeds.rb`)

Superseded by the user-provided photo set at `../spice_photos/`. Kept here rather than
deleted in case they're needed again — not referenced by any code.
